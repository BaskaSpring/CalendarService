...
public class EventsData {
    ...
    public EventsData(Long id, Long idEvent, Instant timestamp, String title, String text, Instant dateBegin, Instant dateEnd, Integer completePercent, Integer parentCompletePercent, String resource, Long userId, Long statusId, String mTree) {
        this.id = id;
